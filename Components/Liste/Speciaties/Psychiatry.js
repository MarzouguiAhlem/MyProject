  ...
  export default function Psychiatry() {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const response = await fetch(`http://192.168.1.129:3000/profile/${patientId}/specialties/Psychiatry/MedicalFiles`);
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Psychiatry Reports</Text>
        <FlatList
          data={list}
          renderItem={({ item }) => (
