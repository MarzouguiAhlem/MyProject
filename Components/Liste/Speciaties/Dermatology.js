  ...
  export default function Dermatology() {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const response = await fetch(`http://192.168.1.129:3000/profile/${patientId}/specialties/Dermatology/MedicalFiles`);
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Dermatology Reports</Text>
        <FlatList
          data={list}
          renderItem={({ item }) => (
