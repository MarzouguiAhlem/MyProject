  ...
  export default function Pediatrics() {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const response = await fetch(`http://192.168.1.129:3000/profile/${patientId}/specialties/Pediatrics/MedicalFiles`);
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Pediatrics Reports</Text>
        <FlatList
          data={list}
          renderItem={({ item }) => (
