  ...
  export default function Pulmonology() {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const response = await fetch(`http://192.168.1.129:3000/profile/${patientId}/specialties/Pulmonology/MedicalFiles`);
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Pulmonology Reports</Text>
        <FlatList
          data={list}
          renderItem={({ item }) => (
