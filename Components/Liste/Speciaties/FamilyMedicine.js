  ...
  export default function FamilyMedicine() {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const response = await fetch(`http://192.168.1.129:3000/profile/${patientId}/specialties/FamilyMedicine/MedicalFiles`);
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>FamilyMedicine Reports</Text>
        <FlatList
          data={list}
          renderItem={({ item }) => (
